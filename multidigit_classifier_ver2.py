...
def extract_digits_from_image(image_path):
    ...
    # 1. Preprocessing: Improved Thresholding and Dilation
    ...
    for cnt in contours:
        ...
        # Refined filtering:
        if w > 5 and h > 10 and w < 50 and h < 50 and h / w > 1.0:
...
def main():
    ...
    image_path = "datasets/test_data/multi_digit_package/0015196.png"  # Replace with your multi-digit image path
